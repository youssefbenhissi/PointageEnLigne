    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Ajouter un employé</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">Informations de contact</label>
                ...
                <div class="form-group">
                    <label for="gender" class="col-sm-3 control-label">Genre</label>
                ...
                <div class="form-group">
                    <label for="schedule" class="col-sm-3 control-label">Calendrier</label>

                    <div class="col-sm-9">
                      <select class="form-control" id="schedule" name="schedule" required>
                        <option value="" selected>- Selecter -</option>
                        <?php
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="datepicker_edit" class="col-sm-3 control-label">Date de naissance</label>
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-3 control-label">Informations de contact</label>
                ...
                <div class="form-group">
                    <label for="edit_gender" class="col-sm-3 control-label">Genre</label>
                ...
                <div class="form-group">
                    <label for="edit_schedule" class="col-sm-3 control-label">Calendrier</label>
