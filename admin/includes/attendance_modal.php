    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Ajouter une présence</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="attendance_add.php">
          		  <div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">ID de l'employée</label>
                ...
                <div class="form-group">
                  	<label for="time_in" class="col-sm-3 control-label">Heure d'entrée</label>
                ...
                <div class="form-group">
                  	<label for="time_out" class="col-sm-3 control-label">Heure de sortie</label>
				...
				<div class="form-group">
                  	<label for="formWheelchair" class="col-sm-3 control-label">Avec repos</label>
                  	<div class="col-sm-9">
