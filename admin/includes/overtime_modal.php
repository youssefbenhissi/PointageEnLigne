    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Ajouter des heures supplémentaires</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="overtime_add.php">
          		  <div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">ID de l'employé</label>
                ...
                <div class="form-group">
                  	<label for="hours" class="col-sm-3 control-label">No. d'heures</label>
                ...
                <div class="form-group">
                  	<label for="mins" class="col-sm-3 control-label">No. de minutes</label>
                 ...
                 <div class="form-group">
                    <label for="rate" class="col-sm-3 control-label">Taux</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="hours_edit" class="col-sm-3 control-label">No. d'heures</label>
                ...
                <div class="form-group">
                    <label for="mins_edit" class="col-sm-3 control-label">No. de minutes</label>
                 ...
                 <div class="form-group">
                    <label for="rate_edit" class="col-sm-3 control-label">Taux</label>
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="overtime_delete.php">
            		...
            		<div class="text-center">
	                	<p>SUPPRIMER LES HEURES SUPPLÉMENTAIRES</p>
